// DE1.java CS5125/6025 Cheng 2019
// converts SVG to PNG
// java DE10A < de1test1.svg > qrcode.png
...
public class DE1 {
  ...
  static final byte[] signature = new byte[] { 137 - 256, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82 };
  static byte[] iend = new byte[] { 0, 0, 0, 0, 'I', 'E', 'N', 'D', 0, 0, 0, 0 };
  ...
  void fillPNGHeader() {
    ...
    PNGHeader[24] = 1;
    // Clear out header CRC area, reset and update CRC
    for (int i = 25; i < 29; i++)
      PNGHeader[i] = 0;
    crc32.reset();
    // args = Byte array, offset, len of bytes to use for computing update
  ...
  void fillIDAT() {
    ...
    compresser.finish();
    // your code for
    // 1. deflate data into idat at position 8, w/len = 38 - 8 for offset and 4 for crc? NOTE: he uses 29 in header
    compressedDataLength = compresser.deflate(idat, 8, data.length-12);
