...
/* from the assignemtn: DE4A, DE4B, and DE4C are programs running Diffie-Hellman
 exchanges.  Complete the programs.  Run DE4A and DE4B on two computers or in 
 two command windows on one computer and make screen shots showing that they 
 share the same secret generated with Diffie-Hellman.  DE4C checks the 
 parameters. */
